...
PLANNER_PROMPT = """You are the Planner node in a RAG pipeline for the Ys series wiki corpus.
...
- Extract key entities (proper nouns / named things / key targets) into an entities array for lexical filtering.
